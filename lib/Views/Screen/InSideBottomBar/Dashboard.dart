                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.contain,
                          image: NetworkImage(
                              "https://ui-avatars.com/api/?name=${controller.store}&color=000000&background=f1f1ff"),
                        ),
                      ),
                    ),
                    // Icon(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.all(Radius.circular(
                                controller.size.defaultSize! * 2.5))),
                        child: Row(
                          children: [
                            Container(
                              margin: EdgeInsets.all(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  fit: BoxFit.contain,
                                  image: NetworkImage(
                                      "https://ui-avatars.com/api/?name=${controller.user.name}&color=000000&background=f1f1ff"),
                                ),
                              ),
                            ),
                            SizedBox(
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                        color: ColorsApp.white,
                                        fontSize:
                                            controller.size.defaultSize! * 1.5),
                                  ),
                                  SizedBox(
                                    width: 5,
                                  ),
                                ...
                                (index) {
                                  return Container(
                                    ...
                                    constraints: BoxConstraints(
                                      maxWidth:
                                          140, // Maximum width of the container
                                      maxHeight:
                                          150, // Maximum height of the container
                                    ),
                                    decoration: BoxDecoration(
                                      color: Colors.white,
                                      borderRadius: BorderRadius.circular(20),
                                      border:
                                          Border.all(color: Color(0xffe7eefc)),
                                    ),
                                    child: Column(
                                      crossAxisAlignment:
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            "${controller.Commande ? controller.statistics[index].command! : controller.statistics[index].price!} ${!controller.Commande ? "DH" : ""}"),
                                      ],
                                    ),
                                  );
                                },
